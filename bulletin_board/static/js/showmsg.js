...
function showPostDetail( title, description, status, createdAt, createdBy,updatedAt,updatedBy) {
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    for (var i = 0; i < postRows.length; i++) {
        postRows[i].addEventListener("click", function() {
            ...
            showPostDetail( title, description, status, createdAt, createdBy,updatedAt,updatedBy);
        });
    }
});
